...
/** Roles that own a full console in this workspace. */
const ROLE_CONSOLE: Partial<Record<RoleKey, string>> = {
...
function DashboardPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Roles that own a dedicated console go straight there.
      const target = ROLE_CONSOLE[(isRoleKey(role) ? role : resolved) as RoleKey];
      if (target) {
